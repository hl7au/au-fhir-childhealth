...
* Consults with other national programs including [AU Base Profiles](http://hl7.org.au/fhir/aubase1.1/profiles.html), Digital Agency Profiles and Terminologies and AU [Argonaut Profiles](http://build.fhir.org/ig/hl7au/argonaut-au/profiles.html). 

![NCHDC FHIR Profiling](cdhrFHIRProfiling.png)
