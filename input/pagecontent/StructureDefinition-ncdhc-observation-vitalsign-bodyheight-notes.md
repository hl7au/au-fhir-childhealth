...
* Refer to the Base Profile: [AUBodyHeight](http://hl7.org.au/fhir/aubase1.1/StructureDefinition-au-bodyheight.html) for base rules that are applied in this profile. 	
