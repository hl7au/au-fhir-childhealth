...
* Refer to the Base Profile: [AUBodyWeight](http://hl7.org.au/fhir/aubase1.1/StructureDefinition-au-bodyweight.html) for base rules that are applied in this profile. 
