...
* Refer to the Base Profile: [AUHeadCircum](http://hl7.org.au/fhir/base/aubase1.1/StructureDefinition-au-headcircum.html) for base rules that are applied in this profile. 		
